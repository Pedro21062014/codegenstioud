                                ...
                                <div className="flex items-center justify-between gap-2">
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <div className="relative">
                                            ...
                                            {showModelDropdown && (
                                                <div className="absolute bottom-full left-0 mb-3 w-64 bg-var-bg-subtle/95 backdrop-blur-xl border-2 border-var-border-default rounded-2xl shadow-2xl p-2 animate-slideInUp">
                                        ...
                                        <div className="relative">
                                            ...
                                            {showAppTypeDropdown && (
                                                <div className="absolute bottom-full left-0 mb-3 w-56 bg-var-bg-subtle/95 backdrop-blur-xl border-2 border-var-border-default rounded-2xl shadow-2xl p-2 animate-slideInUp">
                                                    <div className="max-h-64 overflow-y-auto">
                                                        {APP_TYPES.map((type) => (
                                                            <button
                                                                key={type.id}
                                        ...
                                        <div className="relative">
                                            ...
                                            {showGenerationModeDropdown && (
                                                <div className="absolute bottom-full left-0 mb-3 w-48 bg-var-bg-subtle/95 backdrop-blur-xl border-2 border-var-border-default rounded-2xl shadow-2xl p-2 animate-slideInUp">
                                                    <button
