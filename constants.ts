...
export const AI_MODELS: AIModel[] = [
  ...
  // Modelos OpenRouter (alguns são gratuitos ou de baixo custo, mas todos exigem a chave OpenRouter)
  { id: 'mistralai/mistral-7b-instruct', name: 'Mistral 7B Instruct (OpenRouter)', provider: AIProvider.OpenRouter },
  { id: 'nousresearch/nous-hermes-2-mixtral-8x7b-dpo', name: 'Nous Hermes 2 Mixtral (OpenRouter)', provider: AIProvider.OpenRouter },
  { id: 'google/gemma-7b-it', name: 'Gemma 7B IT (OpenRouter)', provider: AIProvider.OpenRouter },
  { id: 'perplexity/llama-3-8b-instruct', name: 'Llama 3 8B Instruct (OpenRouter)', provider: AIProvider.OpenRouter },
  { id: 'anthropic/claude-3-haiku', name: 'Claude 3 Haiku (OpenRouter)', provider: AIProvider.OpenRouter },
  { id: 'microsoft/phi-3-mini-128k-instruct', name: 'Phi-3 Mini (OpenRouter)', provider: AIProvider.OpenRouter },
];
